...
export function MakeGroupTab({course, changePointsButton}) {
    ...
    const [cardColor, setCardColor]=useState(["blue", "red", "pink", "purple", "light-blue", "violet", "indigo", "blue", "cyan", "teal",
        "green", "lime", "yellow", "light-green", "amber", "orange"])
    ...
    <div className={styles.makeGroup}>
        ...
        <Title>每组人数：</Title>
        <InputNumber min={2} max={6} step={1} defaultValue={2} onChange={num => {
            setGroupNum(num)
        }}/>
        </div>
